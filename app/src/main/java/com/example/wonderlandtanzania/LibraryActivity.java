...
public class LibraryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Redirect_Activity(LibraryActivity.this,MainActivity.class);
            }
        });
        ...
        news_room.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Redirect_Activity(LibraryActivity.this,NewsRoomActivity.class);
            }
        });column.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Redirect_Activity(LibraryActivity.this,ColumnActivity.class);
            }
        });
        photo_repotage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Redirect_Activity(LibraryActivity.this,PhotoRepotageActivity.class);
            }
        });
        library.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Redirect_Activity(LibraryActivity.this,LibraryActivity.class);
            }
        });
        about_us.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Redirect_Activity(LibraryActivity.this,AboutUsActivity.class);
            }
        });
    }
    public void init(){
