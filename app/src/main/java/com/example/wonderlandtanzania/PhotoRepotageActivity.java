...
public class PhotoRepotageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_photo_repotage);
        init();
        ...
        home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Redirect_Activity(PhotoRepotageActivity.this,MainActivity.class);
            }
        });
        ...
        news_room.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Redirect_Activity(PhotoRepotageActivity.this,NewsRoomActivity.class);
            }
        });column.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Redirect_Activity(PhotoRepotageActivity.this,ColumnActivity.class);
            }
        });
        photo_repotage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Redirect_Activity(PhotoRepotageActivity.this,PhotoRepotageActivity.class);
            }
        });
        library.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Redirect_Activity(PhotoRepotageActivity.this,LibraryActivity.class);
            }
        });
        about_us.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Redirect_Activity(PhotoRepotageActivity.this,AboutUsActivity.class);
            }
        });
