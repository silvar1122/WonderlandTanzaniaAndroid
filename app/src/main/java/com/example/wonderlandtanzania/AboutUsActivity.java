...
public class AboutUsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Redirect_Activity(AboutUsActivity.this,MainActivity.class);
            }
        });
        ...
        news_room.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Redirect_Activity(AboutUsActivity.this,NewsRoomActivity.class);
            }
        });column.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Redirect_Activity(AboutUsActivity.this,ColumnActivity.class);
            }
        });
        photo_repotage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Redirect_Activity(AboutUsActivity.this,PhotoRepotageActivity.class);
            }
        });
        library.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Redirect_Activity(AboutUsActivity.this,LibraryActivity.class);
            }
        });
        about_us.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Redirect_Activity(AboutUsActivity.this,AboutUsActivity.class);
            }
        });
    }
    public void init(){
